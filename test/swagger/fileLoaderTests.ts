  ...
  describe("isFileUnderRoot", () => {
    it("should check absolute paths correctly", () => {
      const options: FileLoaderOption = {
        fileRoot:
          "/Users/mikekistler/Projects/Azure/oav/test/liveValidation/swaggers/specification",
      };
      const loader = new FileLoader(options);
      const received = loader.isUnderFileRoot("Users/mikekistler/Projects/Azure/oav/readme.md");
